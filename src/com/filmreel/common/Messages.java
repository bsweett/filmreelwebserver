...
public class Messages {
	...
	public static final String METHOD_GET_USER_BY_NAME = "getUserByName";
	public static final String METHOD_GET_USER_BY_EMAIL_ADDRESS_PASSWORD = "getUserByEmailAddressPasssword";
	public static final String METHOD_GET_USER_BY_ID = "getUserById";
	public static final String METHOD_GET_NUMBER_OF_USERS = "getNumberOfUsers";

	public static final String METHOD_ADD_INBOX = "addInbox";
	public static final String METHOD_UPDATE_INBOX = "updateInbox";
	public static final String METHOD_DELETE_INBOX = "deleteInbox";
