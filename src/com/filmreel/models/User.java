...
/*
=================================================================================
|| This is our user model class. Every user has a token, name, email, password ||
|| location, biography, gender, popularity, reel count, login count, display   ||
|| picture path, multiple time stamps and two sets containing a users friends  ||
|| and inbox's.																   ||
=================================================================================
 */
...
public class User 
{
	...
	/*
	When a user has a friend added
	the users popularity is adjusted 
	accordingly
	*/
